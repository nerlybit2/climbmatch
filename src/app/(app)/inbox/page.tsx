          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-2">
              ...
              <button
                ...
                disabled={actioning}
                className="bg-slate-100 text-slate-600 text-[12px] font-bold rounded-xl px-6 py-2.5 active:scale-[0.97] transition-transform disabled:opacity-60 disabled:scale-100"
              >
...
function ContactIcons({
  phone, instagram, facebook, location,
}: {
  phone: string | null
    ...
    <div className="flex items-center gap-2">
      {hasPhone && (
        <>
          <a
            ...
            className="w-8 h-8 rounded-full bg-[#25D366] flex items-center justify-center active:scale-90 transition-transform shadow-sm"
          >
          ...
          <a
            href={`sms:+${cleanPhone}`}
            className="w-8 h-8 rounded-full bg-slate-200 flex items-center justify-center active:scale-90 transition-transform"
          >
      ...
      {fbHandle && (
        <a
          ...
          target="_blank" rel="noopener noreferrer"
          className="w-8 h-8 rounded-full bg-[#1877F2] flex items-center justify-center active:scale-90 transition-transform shadow-sm"
        >
          <svg className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="currentColor">
