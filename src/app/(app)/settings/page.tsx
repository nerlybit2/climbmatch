      ...
      <div className="px-5 space-y-4 pb-8">
        <div className="bg-white rounded-2xl shadow-sm ring-1 ring-gray-100 overflow-hidden">
          ...
          <button
            ...
            className={`w-full flex items-center justify-between px-4 py-4 border-b border-gray-50 transition-colors ${language === 'en' ? 'bg-orange-50' : 'hover:bg-stone-50'}`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center justify-between px-4 py-4 transition-colors ${language === 'he' ? 'bg-orange-50' : 'hover:bg-stone-50'}`}
          >
            <div className="flex items-center gap-3">
              <span className="text-xl">🇮🇱</span>
